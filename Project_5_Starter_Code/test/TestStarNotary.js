...
it('can add the star name and star symbol properly', async() => {
    ...
    // console.log(await instance.symbol.call())
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    let tokenId = 10;
    let user1 = accounts[1];
    await instance.createStar('awesome star99', tokenId, {from: user1});
    assert.equal(await instance.lookUptokenIdToStarInfo(tokenId), 'awesome star99');
});